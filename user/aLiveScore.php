    ...
    <table id="mainframe"width="100%"height="640px">
        <tr>
            ...
            <td width="75%" valign="top">
                <table  width="100%" border="1">
                    ...
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)){ 
                            ...
                            $str1 = 'aMatch.php?id='.$row['match_id'];
                            $str2 = $row['team1'];
                            $str3 = $row['team2'];
                ...
                <table  width="100%" border="1">
                    <tr>
                        <th><h2>Match Results</h2></th>
                    </tr>
                    
                    <?php
                        $conn = mysqli_connect('localhost', 'root', '', 'criclive');
                        
                        $sql= "SELECT * FROM `play` where `status`='finish'";
                        ...
                        ?>        
                                ...
                                <a href='<?=$str1?>'><center><h3><?=$str2."vs".$str3?></h3></center></a>
                                <center><p style="font-size:15px;"><?=$str2?> <?=$score1?> &nbsp &nbsp &nbsp &nbsp &nbsp <?=$str3?> <?=$score2?></p></center>
                                    <center><p style="font-size:15px;"><?=$str2?> won by <?=$need?> run</p></center>
                    ...
                    ?>
                            ...
                            <tr> <td>
                                <a href='<?=$str1?>'><center><h3><?=$str2."vs".$str3?></h3></center></a>
                                <center><p style="font-size:15px;"><?=$str2?> <?=$score1?> &nbsp &nbsp &nbsp &nbsp &nbsp <?=$str3?> <?=$score2?></p></center>
                                    <center><p style="font-size:15px;"><?=$str3?> won by <?=$need?> run</p></center>
