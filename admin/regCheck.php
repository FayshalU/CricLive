<?php
    ...
    //        $_SESSION['log'] = "validuser";
            ...
            $sql = "INSERT into login values('".$_POST['userName']."','".$_POST['password']."','editor')";
            ...
            $sql2 = "INSERT into editor values('".$_POST['userName']."','".$_POST['password']."','".$_POST['name']."','".$_POST['email']."','".$_POST['country']."','".$date."')";
